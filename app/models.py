...
class Approval(db.Model):
    ...
    po_sign_col = db.Column(db.String(50), nullable=True)
    hop_email = db.Column(db.String(100), nullable=True)
    hop_sign_col = db.Column(db.String(50), nullable=True)
    hop_date_col = db.Column(db.String(50), nullable=True)
    dean_email = db.Column(db.String(100), nullable=True)
    dean_sign_col = db.Column(db.String(50), nullable=True)
    dean_date_col = db.Column(db.String(50), nullable=True)
    ad_email = db.Column(db.String(100), nullable=True)
    ad_sign_col = db.Column(db.String(50), nullable=True)
    ad_date_col = db.Column(db.String(50), nullable=True)
    hr_email = db.Column(db.String(100), nullable=True)
    hr_sign_col = db.Column(db.String(50), nullable=True)
    hr_date_col = db.Column(db.String(50), nullable=True)
    file_name = db.Column(db.String(100), nullable=True)
    file_url = db.Column(db.String(500), nullable=True)
