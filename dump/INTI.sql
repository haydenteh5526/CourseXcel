...
CREATE TABLE `approval` (
  ...
  `po_sign_col` VARCHAR(50) DEFAULT NULL,
  `hop_email` VARCHAR(100) DEFAULT NULL,
  `hop_sign_col` VARCHAR(50) DEFAULT NULL,
  `hop_date_col` VARCHAR(50) DEFAULT NULL,
  `dean_email` VARCHAR(100) DEFAULT NULL,
  `dean_sign_col` VARCHAR(50) DEFAULT NULL,
  `dean_date_col` VARCHAR(50) DEFAULT NULL,
  `ad_email` VARCHAR(100) DEFAULT NULL,
  `ad_sign_col` VARCHAR(50) DEFAULT NULL,
  `ad_date_col` VARCHAR(50) DEFAULT NULL,
  `hr_email` VARCHAR(100) DEFAULT NULL,
  `hr_sign_col` VARCHAR(50) DEFAULT NULL,
  `hr_date_col` VARCHAR(50) DEFAULT NULL,
  `file_name` VARCHAR(100) DEFAULT NULL,
  `file_url` VARCHAR(500) DEFAULT NULL,
